...
function Navbar({ onClick }) {
  return (
    <nav className="bg-gray-800 md:px-16 px-0 bg-opacity-75 shadow-2xl">
        ...
        <a className='pr-9 font-bold text-white hover:underline' href='/'><span className='text-4xl text-gray-200'>User</span> <span className='text-2xl text-gray-400'>Data</span></a>
        <button 
            type="button" 
